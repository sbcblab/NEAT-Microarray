...
def mtanh_activation(z):
    z = max(-60.0, min(60.0, 2.5 * z))
    return math.tanh(4.9*0.5*z)  
...
class ActivationFunctionSet(object):
    ...
    def __init__(self):
        ...
        self.add('msigmoid', msigmoid_activation)        
        self.add('tanh', tanh_activation)
        self.add('mtanh', mtanh_activation)
        self.add('sin', sin_activation)
        self.add('gauss', gauss_activation)
        self.add('mgauss', mgauss_activation)
