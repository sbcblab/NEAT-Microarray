...
from neatB.config import ConfigParameter, DefaultClassConfig
        ...
        for spawn, s in zip(spawn_amounts, remaining_species):
            ...
            if self.reproduction_config.elitism > 0:
                for i, m in old_members[:self.reproduction_config.elitism]:
                    n = copy.deepcopy(m)
                    n.parent1_fit = m.fitness
                    n.parent1_key = m.key
                    n.parent2_fit = None
                    n.parent2_key = None
                    n.generation = m.generation + 1.0
                    new_population[i] = n
                    spawn -= 1
            ...
            while spawn > 0:
                ...
                parent1 = None
                for i in xrange(k):   
                    competitor_id, competitor = random.choice(old_members)               
                    if parent1 is None or competitor.fitness > parent1.fitness:
                        parent1_id = competitor_id
                        parent1 = competitor              
                parent2_id = None
                parent2 = None
                for i in xrange(k):   
                    competitor_id, competitor = random.choice(old_members)               
                    if parent2 is None or competitor.fitness > parent2.fitness:
                        parent2_id = competitor_id
                        parent2 = competitor
                ...
                child.mutate_not_structural(config.genome_config)             
