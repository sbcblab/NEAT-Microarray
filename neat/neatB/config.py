...
class Config(object):
    ...
    def __init__(self, genome_type, reproduction_type, species_set_type, stagnation_type, filename, num_generations, probs):
        ...
        self.genome_config = genome_type.parse_config(genome_dict, num_generations, probs)
